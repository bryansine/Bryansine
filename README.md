...
### 🛒 Timea Classic
[![View Project](https://img.shields.io/badge/View%20Project-%23000000.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/bryansine/Timea_classic)

> Django-powered e-commerce platform built for baby shops — streamlining online sales and enhancing customer experience.

`Django` `React` `PostgreSQL` `JavaScript` `PythonAnywhere`

✅ Full-stack baby shop marketplace with modern UX  
✅ PostgreSQL-backed product and order management  
✅ Responsive frontend with HTML, CSS & React  
...
> AgTech platform for data-driven agricultural field monitoring — bridging Coordinators and Field Agents in real time.

`Django` `Python` `PostgreSQL` `Bootstrap 5` `JavaScript` `Ubuntu`

✅ Dual-role RBAC — separate dashboards & permissions for Coordinators and Field Agents  
✅ Dynamic field tracking — register fields, assign agents, submit real-time status updates  
✅ Smart "At Risk" logic — auto flags fields with no updates in 14 days or manual agent alerts  
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/bryan-sine-53432b1b1/)
...
[![Portfolio](https://img.shields.io/badge/Portfolio-%23000000.svg?style=for-the-badge&logo=vercel&logoColor=white)](https://bryansine.vercel.app/)
